...
public class HistoryRecord {
    ...
    private List<Locations.CaptureRecord> hisImgs;
    ...
    private HistoryRecord() {
        hisImgs = new ArrayList<Locations.CaptureRecord>(10240000);
        shotTimes = new AtomicLongArray(1024000);
    }


    public synchronized void addCaptureRecord(Locations.CaptureRecord record) {
        hisImgs.add(record);
    }
     ...
     * 开枪后的100毫秒内没有识别到敌人
     */
    public List<Locations.CaptureRecord> shotNoDetect() {
     ...
     * 识别到敌人之后的2秒内没有开枪操作
     */
    public List<Locations.CaptureRecord> detectNoShot() {
        List<Locations.CaptureRecord> result = new LinkedList<>();
        ...
        synchronized (this) {
            ...
            while (t < end) {
                Locations.CaptureRecord record = hisImgs.get(t++);
